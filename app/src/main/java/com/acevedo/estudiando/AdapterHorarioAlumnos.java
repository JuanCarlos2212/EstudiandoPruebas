...
public class AdapterHorarioAlumnos extends ArrayAdapter<Horarios> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtCodigo= view.findViewById(R.id.txtPreguntaExamenList);
        TextView txtNombre = view.findViewById(R.id.txtRespuesta);
        TextView txtHorario = view.findViewById(R.id.txtRetroalimentacion);
